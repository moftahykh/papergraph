...
void main() {
  ...
  testWidgets(
    'PaperDetailsView renders on narrow 360px viewport without RenderFlex overflow',
    (tester) async {
      ...
      final paper = PaperModel(
        id: 'paper-101',
        title:
            'Deep Image Matting: A Comprehensive Survey and Experimental Study',
      ...
      await tester.pumpWidget(
        MultiProvider(
          providers: [
            ChangeNotifierProvider<PapersProvider>(
              create: (_) => PapersProvider.seeded(),
            ),
  ...
  testWidgets(
    'CitationBottomSheet with 45+ authors renders on 360x640 with ZERO overflow',
    (tester) async {
